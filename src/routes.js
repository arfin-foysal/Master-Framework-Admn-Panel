    ...
    routes: [
      {
        exact: true,
        path: '/app/role',
        component: lazy(() => import('./views/role-management/Role'))
    },
      {
        exact: true,
        path: '/app/user',
        component: lazy(() => import('./views/role-management/User'))
    },
      {
        exact: true,
        path: '/app/permission',
        component: lazy(() => import('./views/role-management/Permission'))
      },
      // {
      //   exact: true,
      //   path: '/app/permission/:id',
      //   component: lazy(() => import('./views/role-management/PermissionEditAndUpdate'))

      // },
      {
        exact: true,
        path: '/app/assign-role-to-permission',
        component: lazy(() => import('./views/role-management/AssignRoleToPermission'))
      },
